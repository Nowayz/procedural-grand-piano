...
try {
 execFileSync('emcc', [sourcePath, '-O3', '-msimd128', '-s', 'STANDALONE_WASM=1', '--no-entry', '-s', 'EXPORTED_FUNCTIONS=["_synthesize","_output_ptr","_calibration_ptr"]', '-s', 'INITIAL_MEMORY=6291456', '-s', 'ALLOW_MEMORY_GROWTH=0', '-o', unoptimizedPath], { stdio: 'inherit' });
