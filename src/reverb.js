export const DEFAULT_REVERB_IR_URL = new URL('./impulse-responses/small-hall-tail.wav', import.meta.url);
export const DEFAULT_REVERB_WET = 0.18;

function clamp(value, minimum, maximum) {
  return Math.min(maximum, Math.max(minimum, value));
}

export async function createGarageBandStyleReverb(context, { impulseUrl = DEFAULT_REVERB_IR_URL, wet = DEFAULT_REVERB_WET, normalize = true, fetch: fetchImpulse = globalThis.fetch } = {}) {
